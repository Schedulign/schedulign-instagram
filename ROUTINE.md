...
3. **Pick the next posts** until the runway is 14: about four spotlights for every one before/after and one tip, never the same format or character three posts in a row, and no feature covered in the last six weeks. Take new spotlight ideas from the list in STRATEGY.md first.
